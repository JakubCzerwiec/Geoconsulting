    ...
    let publicationsRender = () => {
        ...
        // List of publications
                const publicationsList = document.createElement('ul');
                    ...
                    pub2.innerHTML = 'Stachacz, M., Knaust, D. & <strong>Matysik, M.</strong> (2021) Middle Triassic bivalve traces from central Europe (Muschelkalk, Anisian): overlooked burrows of a common ichnofabric. PalZ. Free full text available at: <a href="https://link.springer.com/content/pdf/10.1007/s12542-021-00583-6.pdf" target="blank">[click]</a>';
